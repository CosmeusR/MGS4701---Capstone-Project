...
<img width="601" height="610" alt="Screenshot 2026-05-07 211935" src="https://github.com/user-attachments/assets/d70bed8b-cd20-4dd6-a4cf-2f588bcfd4c3" />

The correlation heatmap displays several clear patterns in quarterback performance. Quarterbacks who throw more passes tend to record more completions, attempts, passing yards, touchdowns, and first downs. The heatmap also shows a second group of efficiency variables, including Y/A, AY/A, NY/A, ANY/A, and passer rating, which move closely together because they measure similar parts of quarterback performance.

At the same time, not every variable followed the same pattern. Interception percentage showed weaker and sometimes negative relationships with efficiency-based measures, which supports the idea that more mistakes tend to lower passing quality. Year and Age had weaker relationships with most of the other variables, suggesting they were not central to the main performance structure in the dataset. Overall, the heatmap shows that many quarterback statistics were strongly related, which helps explain why the first principal components captured such a large share of the variation.

<img width="725" height="574" alt="Corr Heatmap" src="https://github.com/user-attachments/assets/ce919e3e-cadd-4980-a320-67d975037b8b" />
...
<img width="605" height="344" alt="ROC CURVE" src="https://github.com/user-attachments/assets/82b9f5d0-0542-492c-9bd8-69985951edef" />
<img width="497" height="538" alt="PCA Graph" src="https://github.com/user-attachments/assets/816ef6bf-77a7-46a7-9ab1-bae07690af5c" />
